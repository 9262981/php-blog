 ...
 */
	...
	$_result= _query("
					SELECT article_id,article_title,article_type,article_readcount,article_commendcount,article_date,article_username,article_cid
					FROM pppf_article 
...
<title><?=$_system['webname']?>-首页</title>
